...
public interface ApiService {
    ...
    @GET("getdetail.php")
    Single<List<Detail>> getDetails(@Query("id") String id,@Query("user") String user);
    ...
    Single<Message> sendParam(@Query("title") String title,
    ...
    @GET("favorite.php")
    Single<Message> addFavorite(@Query("email") String email,
                                @Query("id") String id,
                                @Query("parent") int parent,
                                @Query("title") String title);

    @GET("getfavorite.php")
    Single<List<Favorite>> getFavorites(@Query("email") String email);
